...
class Application extends \Zippy\WebApplication
{
    ...
    public function getTemplate($name, $layout = '') {
        ...
        if (file_exists(strtolower($path)) == false) {
            throw new \App\System\Exception('Invalid template path: ' . strtolower($path));
        }
    ...
    public function Route($uri) {
        ...
        $pages = array(
            ...
            "howworks" => "\\App\\Pages\\HowWorks",
            "blogs" => "\\App\\Pages\\BlogList",
            "blog" => "\\App\\Pages\\BlogArticle",
            "home" => "\\App\\Pages\\Home",
            "images" => "\\App\\Pages\\LoadImage",
            "main" => "\\App\\Pages\\Main");
